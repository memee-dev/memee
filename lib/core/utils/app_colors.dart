...
mixin AppColors {
  ...
  static const Color displayColor = Color(0xFF1A1818);
  static const Color labelColor = Color(0xFF312F2F);

  static const Color switcherOFF = Color(0xFF7A7A7A);
  static const Color switcherON = Color(0xFFE9AF00);

  static const Color textAccentLightColor = Color(0xFFB38600);
  static const Color textAccentDarkColor = Color(0xFFAB8100);
  static const Color textDarkColor = Color(0xFF1A1818);
